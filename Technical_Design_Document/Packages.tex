...
\fancypagestyle{plain}
	...
	\fancyhead[R]{Dying Hamsters - Technical Design Document}% Right header
	\fancyhead[L]{\includegraphics[width=2cm]{../Pictures/Unimi_logo.png}
					\includegraphics[width=2cm]{../Pictures/pong_logo.png}}% Left header
...
\newcommand{\sidewrapgraphicsquoted}[3]
	{
	\begin{wrapfigure}[#2]{r}{0.5\linewidth}
	\centering
	\includegraphics[max width=0.5\textwidth]{#1} 
